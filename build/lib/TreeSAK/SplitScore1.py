...
if __name__ == '__main__':
    ...
    SplitScore1_parser.add_argument('-i',   required=True,                        help='OrthologousGroups.txt, produced by OMA')
    SplitScore1_parser.add_argument('-s',   required=True,                        help='OrthologousGroupsFasta, produced by OMA')
    SplitScore1_parser.add_argument('-u',   required=False, default= None,        help='ID of interested genomes, no file extension')
    ...
    SplitScore1_parser.add_argument('-c',   required=False, type=int, default=80, help='coverage cutoff, default: 80')
    SplitScore1_parser.add_argument('-f',   required=False, action="store_true",  help='force overwrite')
    SplitScore1_parser.add_argument('-jst', required=False, type=int, default=3,  help='num of threads for inferring gene tree, default: 3')
