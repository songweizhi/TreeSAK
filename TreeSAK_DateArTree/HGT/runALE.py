...
wd                              = '/Users/songweizhi/Desktop/DateArTree/0_HGT_ALE_r214_rd2'
...
orthogroups_op_txt              = '%s/Orthogroups.txt'                                          % wd    # produced by OrthoFinder, /home-user/wzsong/DateArTree_GTDB_r214/03_orthofinder/Orthogroups/Orthogroups.txt
genome_taxon_txt                = '%s/genome_taxon.txt'                                         % wd    # genome taxonomy
combined_faa                    = '%s/combined_d__Archaea_o_rs.faa'                             % wd    # /home-user/wzsong/DateArTree_GTDB_r214/03_orthofinder/combined_d__Archaea_o_rs.faa
...
# once the submitted jos all finished, download op_qualified_OGs and replace with it the old one

# file in
genome_tree_file                = '%s/Marker_set_1_PA_75_C60_PMSF_concatenated.treefile'            % wd
outgroup                        = '%s/outgroup_gnm.txt'                                             % wd
gene_tree_dir                   = '%s/op_qualified_OGs'                                             % wd
force_create_ale_wd             = False
...
# once the submitted jos all finished, download ale_wd and replace with it the old one

# file in
# defined above: gene_tree_dir and ale_wd
ar_phylum_color_code_txt        = '/Users/songweizhi/Desktop/DateArTree/ar_phylum_color_code.txt'

hgt_freq_cutoff                 = 0.8                       # filter ALE predicted HGTs
